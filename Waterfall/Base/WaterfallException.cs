...
namespace Waterfall.Base
{
    ...
    {
        private WaterfallException(string message, Exception inner) : base(message, inner) {}

        internal WaterfallException(WaterfallErrorType errorType, string message, Exception inner = null) : this(message, inner)
        {
            ErrorType = errorType;
        }
